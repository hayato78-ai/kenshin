...
const SHEET_DEFINITIONS = {
  ...
  '健康保険組合マスタ': {
    headers: [
      '組合ID', '組合名', '組合コード', '連絡先電話',
      '住所', '備考', '表示順', '有効フラグ',
      '作成日時', '更新日時'
    ],
    columnWidths: {
      A: 100, B: 200, C: 100, D: 120,
      E: 250, F: 200, G: 60, H: 70,
      I: 150, J: 150
    },
    sampleData: [
      ['HI00001', '関東IT健康保険組合', 'KIT001', '03-1234-5678',
       '東京都千代田区〇〇1-2-3', '', 1, true,
       new Date(), new Date()]
    ]
  },
  ...
  '事業所マスタ': {
    headers: [
      '事業所ID', '組合ID', '事業所名', '事業所コード',
      '連絡先電話', '住所', '備考', '表示順', '有効フラグ',
      '作成日時', '更新日時'
    ],
    columnWidths: {
      A: 100, B: 100, C: 200, D: 100,
      E: 120, F: 250, G: 200, H: 60, I: 70,
      J: 150, K: 150
    },
    sampleData: [
      ['BO00001', 'HI00001', '○○商事 本社事業所', 'MRJ001',
       '03-2345-6789', '東京都港区〇〇2-3-4', '', 1, true,
       new Date(), new Date()]
    ]
  },
  ...
  '企業マスタ': {
    headers: [
      '企業ID', '事業所ID', '企業名', '企業コード',
      '連絡先電話', '住所', '担当者名', '担当者メール',
      '備考', '表示順', '有効フラグ',
      '作成日時', '更新日時'
    ],
    columnWidths: {
      A: 100, B: 100, C: 200, D: 100,
      E: 120, F: 250, G: 100, H: 180,
      I: 200, J: 60, K: 70,
      L: 150, M: 150
    },
    sampleData: [
      ['CO00001', 'BO00001', '○○商事株式会社', 'MRJ-CO001',
       '03-3456-7890', '東京都港区〇〇2-3-4', '山田花子', 'hanako@example.co.jp',
       '', 1, true,
       new Date(), new Date()]
    ]
  },
  ...
  '企業コース紐付け': {
    ...
    sampleData: [
      ['CO00001', 'CRS001', true, 'INSURANCE',
       null, null, null,
       '生活習慣病ドック（健保全額負担）', true, new Date()]
    ]
  },
  ...
  '検診種別マスタ': {
    ...
    columnWidths: {
      A: 80, B: 150, C: 100, D: 60,
      E: 70, F: 150, G: 150
    },
    sampleData: [
      ['DOCK', '人間ドック', 'DOCK', 1, true, new Date(), new Date()],
      ['REGULAR', '定期検診', 'REGULAR', 2, true, new Date(), new Date()],
      ['EMPLOY', '雇入検診', 'EMPLOY', 3, true, new Date(), new Date()],
      ['ROSAI', '労災二次検診', 'ROSAI', 4, true, new Date(), new Date()],
      ['SPECIFIC', '特定健診', 'SPECIFIC', 5, true, new Date(), new Date()]
    ]
  },
  ...
  'コースマスタ': {
    headers: [
      'コースID', '種別ID', 'コース名', 'コースコード',
      '料金', '表示順', '有効フラグ',
      '作成日時', '更新日時'
    ],
    columnWidths: {
      A: 80, B: 80, C: 200, D: 100,
      E: 80, F: 60, G: 70,
      H: 150, I: 150
    },
    sampleData: [
      ['CRS001', 'DOCK', '生活習慣病ドック', 'LIFESTYLE', 25000, 1, true, new Date(), new Date()],
      ['CRS002', 'DOCK', '人間ドック標準', 'STANDARD', 45000, 2, true, new Date(), new Date()],
      ['CRS003', 'DOCK', 'がんドック', 'CANCER', 80000, 3, true, new Date(), new Date()],
      ['CRS004', 'DOCK', 'レディースドック', 'LADIES', 55000, 4, true, new Date(), new Date()],
      ['CRS010', 'REGULAR', '定期健診A', 'REGULAR-A', 8000, 1, true, new Date(), new Date()],
      ['CRS011', 'REGULAR', '定期健診B', 'REGULAR-B', 12000, 2, true, new Date(), new Date()],
      ['CRS020', 'EMPLOY', '雇入時健診', 'EMPLOY-STD', 10000, 1, true, new Date(), new Date()],
      ['CRS030', 'ROSAI', '労災二次健診', 'ROSAI-2ND', 0, 1, true, new Date(), new Date()],
      ['CRS040', 'SPECIFIC', '特定健康診査', 'SPECIFIC-STD', 0, 1, true, new Date(), new Date()]
    ]
  },
  ...
  // マッピングパターンマスタ（AIマッピング結果の保存・再利用）
  'M_MappingPattern': {
    headers: [
      'パターンID', 'ソース名', 'ヘッダーハッシュ', 'マッピングJSON',
      '値変換JSON', '使用成功回数', '作成日時', '更新日時'
    ],
    columnWidths: {
      A: 100, B: 180, C: 120, D: 300,
      E: 200, F: 100, G: 150, H: 150
    },
    sampleData: []
  },
  ...
  // レポートマッピングマスタ（Excel出力時のセル対応定義）
  'M_ReportMapping': {
    headers: [
      'マッピングID', 'テンプレートID', 'フィールド名', 'セル位置',
      'データ型', 'フォーマット', '備考', '有効フラグ',
      '作成日時', '更新日時'
    ],
    columnWidths: {
      A: 120, B: 120, C: 150, D: 80,
      E: 80, F: 120, G: 200, H: 70,
      I: 150, J: 150
    },
    sampleData: [
      // 標準一覧表テンプレートのヘッダーマッピング
      ['MAP_STD_001', 'TPL_STANDARD', 'companyName', 'A1', 'TEXT', '', '企業名', true, new Date(), new Date()],
      ['MAP_STD_002', 'TPL_STANDARD', 'reportDate', 'H1', 'DATE', 'YYYY/MM/DD', '作成日', true, new Date(), new Date()],
      ['MAP_STD_003', 'TPL_STANDARD', 'examDateRange', 'A2', 'TEXT', '', '受診期間', true, new Date(), new Date()],
      ['MAP_STD_004', 'TPL_STANDARD', 'totalCount', 'H2', 'NUMBER', '', '総人数', true, new Date(), new Date()],
      // データ行マッピング（行番号は動的に設定）
      ['MAP_STD_010', 'TPL_STANDARD', 'rowNum', 'A', 'NUMBER', '', 'No.', true, new Date(), new Date()],
      ['MAP_STD_011', 'TPL_STANDARD', 'patientName', 'B', 'TEXT', '', '氏名', true, new Date(), new Date()],
      ['MAP_STD_012', 'TPL_STANDARD', 'gender', 'C', 'TEXT', '', '性別', true, new Date(), new Date()],
      ['MAP_STD_013', 'TPL_STANDARD', 'age', 'D', 'NUMBER', '', '年齢', true, new Date(), new Date()],
      ['MAP_STD_014', 'TPL_STANDARD', 'examDate', 'E', 'DATE', 'YYYY/MM/DD', '受診日', true, new Date(), new Date()],
      ['MAP_STD_015', 'TPL_STANDARD', 'courseName', 'F', 'TEXT', '', 'コース', true, new Date(), new Date()],
      ['MAP_STD_016', 'TPL_STANDARD', 'overallJudgment', 'G', 'TEXT', '', '総合判定', true, new Date(), new Date()],
      ['MAP_STD_017', 'TPL_STANDARD', 'findings', 'H', 'TEXT', '', '所見概要', true, new Date(), new Date()],
      // 8名リストテンプレートのマッピング
      ['MAP_8L_001', 'TPL_8LIST', 'companyName', 'A1', 'TEXT', '', '企業名', true, new Date(), new Date()],
      ['MAP_8L_002', 'TPL_8LIST', 'reportDate', 'F1', 'DATE', 'YYYY/MM/DD', '作成日', true, new Date(), new Date()]
    ]
  },
